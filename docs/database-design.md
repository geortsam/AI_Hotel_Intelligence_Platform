...
> predictions, LLM invocations, knowledge documents, copilot conversations); the head is now
> `0015_copilot_conversations` over 27 application tables. The "design only" status line below
