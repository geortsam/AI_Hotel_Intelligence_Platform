...
and Stage 7.6 a third: head is now `0012_audit_tool_invoked` across 12 linear revisions, still
with no branch points.)* The schema carries its rules rather than delegating them to application code:
